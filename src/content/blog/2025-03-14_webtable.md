...
tags:
  ...
  - wide column
  - data modelling
published_at: 2025-03-14T15:55:27.431Z
last_modified_at: 2025-03-14T15:55:27.431Z
...
impl WideColumnTable {
  ...
  pub fn prefix(
        ...
        self.primary.prefix(prefix.into()).map(|kv| {
            // ignore the Cell::new syntax, it's some nasty self_cell stuff
...
impl Webtable {
    pub fn new(keyspace: Keyspace) -> fjall::Result<Self> {
        // write anchors and contents into this db
        let inner = WideColumnTable::new(keyspace.clone(), "webtable")?;

        // write metadata (checksum and language) into this db
